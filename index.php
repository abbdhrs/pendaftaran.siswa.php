  ...
  <head>
    ...
    <style>
      * {
      ...
      .hero {
        background-image: url('sekolah.webp');
        overflow: hidden;
  ...
  <body>
    ...
    <section class="carousel pt-5">
      <div class="hero d-flex align-items-center justify-content-center text-light">
        <div class="row p-4 text-center position-absolute text-primary">
          <div class="col">
            <h1 class="fw-bold">Selamat Datang di SMK JAYAPURA</h1>
          </div>
        </div>
    ...
    <section class="container">
      <div class="row p-4 pt-5 pb-5 mt-5 mb-5 justify-content-center">
        ...
        <div class="col-md-2 p-3">
          <img src="G20-Presidency-of-Indonesia.png" class="w-100" alt="">
        </div>
      </div>
    </section>
    ...
    <footer class="bg-dark p-4 d-flex justify-content-center">
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1177.6246868170767!2d109.66462098646103!3d-6.885631389517207!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e70251b5e1a6f57%3A0x73eb625318184632!2sSMK%20Negeri%202%20Pekalongan!5e0!3m2!1sid!2sid!4v1715732446064!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </footer>
